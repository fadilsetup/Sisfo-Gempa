...
<html lang="en">
  <head>
    ...
    <title>.arkAdmin Sisfo Gempa Ver 1.0</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url(); ?>">Admin Panel Sisfo Gempa</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li ><a href="localhost/kalkun/index.php">SMS Gateway</a></li>
            <li class="dropdown">
